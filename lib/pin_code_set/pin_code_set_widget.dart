...
import '/components/on_board_complete_modal_widget.dart';
          ...
          wrapWithModel(
            ...
            child: HeaderWidget(
              title: FFLocalizations.of(context).getText(
                'axnl4nqb' /* Establezca el código PIN de su... */,
              ),
              showBackButton: true,
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Lottie.asset(
                    'assets/lottie_animations/enter_pin.json',
                    width: 250.0,
                    height: 250.0,
                    fit: BoxFit.cover,
                    animate: true,
                            ...
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'ynlhcblg' /* Agregue un número PIN para hac... */,
                                ),
                          ...
                          Padding(
                            ...
                            child: PinCodeTextField(
                              ...
                              pinTheme: PinTheme(
                                ...
                                activeColor: const Color(0x1A000000),
                                inactiveColor: const Color(0x1A000000),
                                selectedColor:
                                    FlutterFlowTheme.of(context).primaryText,
                              ),
              ...
              ].divide(const SizedBox(height: 24.0)).addToEnd(const SizedBox(height: 24.0)),
            ),
          ),
          Row(
            mainAxisSize: MainAxisSize.max,
