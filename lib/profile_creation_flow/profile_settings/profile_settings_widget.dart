          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'w0alhgdq' /* Configuraciones de la cuenta */,
                  ),
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'nicwhctv' /* Evalúe sus opciones a continua... */,
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '8rlvkqam' /* Política de privacidad */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleLarge
                                  .override(
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'lx2c8zqj' /* Versiones de la aplicación */,
                  ),
