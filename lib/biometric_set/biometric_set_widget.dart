...
import '/components/info_confirm_modal_widget.dart';
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (isBiometricSupported) {
        _model.biometricEnabled = await localAuth.authenticate(
          ...
          'kgjirwzz' /* You want to enable the biometr... */,
        ));
        safeSetState(() {});
      }
          ...
          wrapWithModel(
            ...
            child: HeaderWidget(
              title: FFLocalizations.of(context).getText(
                'p1lcthmv' /* Establezca su Huella Dactilar */,
              ),
              showBackButton: true,
            ),
          ),
                            ...
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '89k388fn' /* Please put your finger on the ... */,
                                ),
