      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'mzpid5ig' /* A continuación, sus chats y ch... */,
              ),
              ...
              child: Padding(
                ...
                child: StreamBuilder<List<ChatsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ChatsRecord> wrapChatsRecordList = snapshot.data!;
                    if (wrapChatsRecordList.isEmpty) {
                      return Center(
                        child: SizedBox(
                    ...
                    return Wrap(
                      ...
                      children: List.generate(wrapChatsRecordList.length,
                          (wrapIndex) {
                        final wrapChatsRecord = wrapChatsRecordList[wrapIndex];
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    if (wrapChatsRecord.users.length <= 2) {
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 12.0, 12.0),
                                        child: FutureBuilder<UsersRecord>(
                                          future: FFAppState().userDocQuery(
                                            uniqueQueryKey:
                                                wrapChatsRecord.reference.id,
                                            requestFn: () => UsersRecord
                                                .getDocumentOnce(wrapChatsRecord
                                                    .users
                                                    .where((e) =>
                                                        e !=
