                ...
                if (widget.chatRef!.users.length <= 2) {
                  ...
                  return Row(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 12.0, 4.0),
                        child: SizedBox(
                          width: 54.0,
                          height: 44.0,
                          child: Stack(
                                ...
                                child: FutureBuilder<UsersRecord>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          if (secondUserUsersRecord.photoUrl !=
                                                  '') {
                                            return Padding(
                                              padding: const EdgeInsets.all(2.0),
                                              child: ClipRRect(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                await showModalBottomSheet(
                  ...
                  barrierColor: FlutterFlowTheme.of(context).primaryText,
                  useSafeArea: true,
                  context: context,
                  builder: (context) {
                    return Padding(
