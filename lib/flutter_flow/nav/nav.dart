...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const ListviewHomeWidget() : const Auth3LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? const ListviewHomeWidget()
        ...
        FFRoute(
          name: 'ListMemberSearch',
          path: '/listMemberSearch',
          builder: (context, params) => const ListMemberSearchWidget(),
        ),
        FFRoute(
          name: 'listviewHome',
          path: '/listviewHome',
          builder: (context, params) => const ListviewHomeWidget(),
        ),
        FFRoute(
          name: 'DetallesMiembros',
          path: '/detallesMiembros',
          builder: (context, params) => DetallesMiembrosWidget(
            idInversor: params.getParam(
              'idInversor',
        ...
        FFRoute(
          ...
          path: '/contenidoExclusivo',
          builder: (context, params) => const ContenidoExclusivoWidget(),
        ),
        FFRoute(
          name: 'ingresarPhone',
          path: '/ingresarPhone',
          builder: (context, params) => const IngresarPhoneWidget(),
        ),
        FFRoute(
          name: 'ingresarPinCode',
          path: '/pincode',
          builder: (context, params) => const IngresarPinCodeWidget(),
        ),
        FFRoute(
          name: 'Language',
          path: '/language',
